package section_one.thread_state;

import section_one.thread_demo.Calculator;

/**
 * 线程中含有4个属性,id,name,priority(线程优先级),状态,其中状态和id不可修改
 ...
 * waiting,time waiting,调用interrupt方法时直接抛出interruptException,并重置线程打断状态为false
 * 在设置线程优先级的时候
